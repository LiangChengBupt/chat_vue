...
export default {
  ...
  methods: {
    addMessageByClick() {
      ...
      //发送群聊消息
      if (this.currentSession.username.includes('群')) {
        console.log(this.content);
        msgObj.groupName = this.$store.state.currentSession;
      ...
      //发送私聊消息
        ...
        let current = this.$store.state.currentUser;
        let currenTo = this.$store.state.users.find(obj => obj.username === msgObj.to);
